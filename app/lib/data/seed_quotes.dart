...
const List<Quote> kSeedQuotes = [
  ...
  Quote(
    id: 'h2',
    text: 'You will rise again, and this time, on your own terms.',
    author: 'Mirra',
    categoryId: 'healing',
  ),
  ...
  Quote(
    id: 's2',
    text: 'Breathe in calm. Breathe out worry.',
    author: 'Mirra',
    categoryId: 'stress',
  ),
  ...
  Quote(
    id: 'x1',
    text: 'Become what you believe \u2014 reinforce it daily.',
    author: 'Mirra',
    categoryId: 'motivation',
  ),
  Quote(
    id: 'x2',
    text: 'Soft heart, strong spine.',
    author: 'Mirra',
    categoryId: 'confidence',
  ),
  Quote(
    id: 'x3',
    text: 'You are allowed to outgrow people, places and patterns.',
    author: 'Mirra',
    categoryId: 'life',
  ),
  Quote(
    id: 'x4',
    text: 'Whatever calms your nervous system is where you belong.',
    author: 'Mirra',
    categoryId: 'mindfulness',
  ),
  Quote(
    id: 'x5',
    text: 'Stop shrinking to fit places you\u2019ve outgrown.',
    author: 'Mirra',
    categoryId: 'women',
  ),
  Quote(
  ...
  Quote(
    id: 'x7',
    text: 'Trust the gentle pace of your becoming.',
    author: 'Mirra',
    categoryId: 'mindfulness',
  ),
];
